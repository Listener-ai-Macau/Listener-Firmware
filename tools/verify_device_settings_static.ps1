...
Assert-Contains $statusLed 'STATUS_LED_CHARGING_BREATH_PERIOD_MS 2200U' 'plugged charging breath uses a calmer visible cycle'
...
Assert-Contains $statusLed 'status_led_eased_triangle_percent' 'plugged charging breath uses an eased curve near the dim valley'
