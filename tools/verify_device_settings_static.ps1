...
Assert-Contains $statusLed 'STATUS_LED_CHARGING_BREATH_PERIOD_MS 2600U' 'plugged charging breath uses a calmer visible cycle'
Assert-Contains $statusLed 'STATUS_LED_CHARGING_BREATH_LOW_HOLD_MS 450U' 'plugged charging breath holds the dim valley'
Assert-Contains $statusLed 'STATUS_LED_CHARGING_BREATH_HIGH_HOLD_MS 120U' 'plugged charging breath briefly holds the peak'
