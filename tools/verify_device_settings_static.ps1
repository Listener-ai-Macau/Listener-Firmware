...
Assert-Contains $statusLed 'STATUS_LED_CHARGING_BREATH_PERIOD_MS 3600U' 'plugged charging breath uses a calmer visible cycle'
Assert-Contains $statusLed 'STATUS_LED_CHARGING_BREATH_LOW_HOLD_MS 300U' 'plugged charging breath briefly holds the dim valley'
Assert-Contains $statusLed 'STATUS_LED_CHARGING_BREATH_RISE_MS 1050U' 'plugged charging breath uses a quicker inhale'
Assert-Contains $statusLed 'STATUS_LED_CHARGING_BREATH_HIGH_HOLD_MS 80U' 'plugged charging breath only lightly holds the peak'
Assert-Contains $statusLed 'STATUS_LED_CHARGING_BREATH_MIN_PERCENT 1U' 'plugged charging breath has a deeper dim valley'
...
Assert-Contains $statusLed 'status_led_charging_breath_percent' 'plugged charging breath uses a dedicated valley-hold curve'
