...
Assert-Contains $statusLed 'STATUS_LED_CHARGING_BREATH_PERIOD_MS 1400U' 'plugged charging breath uses a more visible cycle'
Assert-Contains $statusLed 'STATUS_LED_CHARGING_BREATH_MIN_PERCENT 12U' 'plugged charging breath has a deeper dim valley'
