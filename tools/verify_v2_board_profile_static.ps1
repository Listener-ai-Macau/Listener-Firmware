...
foreach ($item in @(
    ...
    @($batteryMonitor, "BATTERY_MONITOR_EMPTY_MV 2800U", "protected product empty battery voltage"),
    ...
    @($board, "product_empty_2800mv_full_4150mv_absolute_min_2700mv_adc_dmm_trim_nvs", "battery percentage policy output"),
