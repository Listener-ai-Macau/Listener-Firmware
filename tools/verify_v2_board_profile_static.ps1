...
foreach ($item in @(
    ...
    @($board, "recording_key=EC11_KEY/GPIO18", "EC11 recording key GPIO diagnostic"),
...
foreach ($item in @(
    ...
    @($powerManager, "KEY4/GPIO21|EC11-KEY/GPIO35|wake_policy|wake_gpio|PWR_HOLD/GPIO46", "stale wake diagnostics"),
