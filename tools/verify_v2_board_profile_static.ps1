...
foreach ($item in @(
    ...
    @($currentTelemetryTool, 'rail=TPS63020_3V3|rail=SY7088_LED_5V|wake_key_gpio=11|voice_key_gpio=11|wake_user_action=""press_ec11_key_or_usb_reset""|wake_capable_keys=EC11_KEY/GPIO18', "stale current telemetry collector diagnostics"),
    @($powerManager, "KEY4/GPIO21|EC11-KEY/GPIO35|wake_policy|wake_gpio", "stale wake diagnostics"),
    @($lowPowerDoc, "EC11-KEY_IO/GPIO11|EC11-KEY/GPIO35|KEY4/GPIO21|wake_policy|wake_gpio", "stale low-power wake doc GPIO"),
