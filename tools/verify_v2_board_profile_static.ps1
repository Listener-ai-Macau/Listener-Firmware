...
foreach ($item in @(
    ...
    @($batteryMonitor, "BATTERY_MONITOR_ADC_SOURCE_IMPEDANCE_NUMERATOR 1045U", "68K/68K battery ADC source-impedance compensation numerator"),
    ...
    @($board, "product_empty_2800mv_full_4200mv_absolute_min_2700mv_adc_source_impedance_x1045", "battery percentage policy output"),
