...
function New-FeatureSnapshot {
    return [ordered]@{
        ...
        major_features = @(
            ...
            "power_manager low-power state machine for connected idle, disconnected idle, charge-aware automatic sleep blocking, overnight sleep, N4 KEY4/GPIO21 wake diagnostics, production wake-policy blockers, and power blockers.",
