...
telemetry inputs populated on the current V2 N16R8 board:
  - TPS63020_I_ADC / GPIO10 / BAT_IN -> VIN_TPS63020
  - SY7088_I_ADC / GPIO9 / BAT_IN -> VIN_SY7088

Future revised board profiles may mark either input absent with GPIO_NUM_NC.
...
function New-SelfTestLines {
    return @(
        ...
        "~BOARD:POWER branch=TPS63020_input_branch present=1 gpio=10 raw_adc=9 adc_mv=8 adc_calibrated=1 sample_count=4 calibration_status=ina180a2_10mR_adc_calibrated_battery_adc_calibrated current_model=""INA180A2 10mR current_mA=adc_mv*2"" current_calibrated=1 current_ma_valid=1 estimated_input_current_ma=16 battery_side_mv=4022 battery_voltage_source=""BAT_V_ADC/GPIO8 68K/68K midpoint, VBAT~=2*ADC"" power_mw_valid=1 estimated_input_power_mw=64 result=ESP_OK policy=v2_battery_side_input_branch_current_ina180a2_10mR_adc_mv_x2_with_battery_mv_from_gpio8_div2",
        "~BOARD:POWER branch=SY7088_input_branch present=1 gpio=9 raw_adc=205 adc_mv=183 adc_calibrated=1 sample_count=4 calibration_status=ina180a2_10mR_adc_calibrated_battery_adc_calibrated current_model=""INA180A2 10mR current_mA=adc_mv*2"" current_calibrated=1 current_ma_valid=1 estimated_input_current_ma=366 battery_side_mv=4046 battery_voltage_source=""BAT_V_ADC/GPIO8 68K/68K midpoint, VBAT~=2*ADC"" power_mw_valid=1 estimated_input_power_mw=1480 result=ESP_OK policy=v2_battery_side_input_branch_current_ina180a2_10mR_adc_mv_x2_with_battery_mv_from_gpio8_div2",
