...
function New-SelfTestLines {
    return @(
        ...
        "~POWER:STATUS state=CONNECTED_IDLE blockers=0x00000000 blocker_names=none shutdown_blockers=0x00000000 shutdown_blocker_names=none idle_ms=100 user_idle_ms=100 radio_idle_ms=100 ble_connected=1 automatic_shutdown_enabled=1 automatic_shutdown_blocked_by_external_power=0 external_power_present=0 usb_power_present=0 usb_serial_jtag_sof_active=0 charging=0 charge_full=0 usb_det_level=nc bat_chg_level=high bat_std_level=high usb_det_policy=not_populated_use_usb_serial_jtag_sof_and_charger_status charger_polarity=v2_gpio14_chg_gpio21_std_active_low battery_mv=3988 battery_level=82 battery_valid=1 last_shutdown_reason=manual_command last_shutdown_idle_ms=100 last_shutdown_blockers=0x00000000 guard=1 audio_idle_ms=60000 low_power_idle_ms=60000 connected_idle_ms=60000 disconnected_idle_ms=60000 hardware_shutdown_ms=1800000 pwr_hold_gpio=9 pwr_hold_level=low pwr_hold_configured=1 pwr_hold_policy=v2_gpio9_power_latch_runtime_low_drive_high_for_hardware_shutdown voice_key_gpio=18 hardware_shutdown_user_action=""short-press hardware power key for cold boot after PWR_HOLD/GPIO9 drive-high shutdown"""
    )
}
