...
function Test-ChargingAwakeTranscript {
    ...
    Assert-Contains -Text $text -Pattern '(?m)^~BOARD:STATUS\s+.*pwr_hold_gpio=11.*pwr_hold_configured=1.*runtime_low_release_high' -Description "PWR_HOLD/GPIO11 is actively driven low during runtime and released high for hardware shutdown"
