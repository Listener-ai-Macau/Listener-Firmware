...
function Test-ChargingAwakeTranscript {
    ...
    Assert-Contains -Text $text -Pattern '(?m)^~BOARD:STATUS\s+.*pwr_hold_gpio=11.*pwr_hold_level=low.*hold_low_release_high' -Description "PWR_HOLD/GPIO11 is held low during runtime and releases high for hardware shutdown"
