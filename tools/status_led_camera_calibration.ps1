...
STATUS_EFFECT_BASELINE = "status_key_ec11_edge_true_state_v26"
...
def make_semantic_sequence(zones_text):
    ...
    return zones, [
        ...
        },
        {
            ...
            "expected_leds": ["PWR"],
            "expected": "PWR white natural breath for charging, with a real dim valley, short valley hold, and slow exhale",
            "acceptance_focus": "charging visibly breathes without a permanent bright lamp, hard blink, or abrupt triangle-wave ramp",
            "sample_delay_ms": 900,
