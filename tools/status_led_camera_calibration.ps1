...
def make_semantic_sequence(zones_text):
    ...
    return zones, [
        ...
        },
        {
            ...
            "expected_leds": ["PWR"],
            "expected": "PWR white natural breath for charging, with a real dim valley and slow exhale",
            "acceptance_focus": "charging is visible without a permanent bright lamp or abrupt triangle-wave ramp",
            "sample_delay_ms": 900,
