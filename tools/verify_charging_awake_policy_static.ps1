...
Assert-Contains $powerManager 'bool\s+charger_active\s*=\s*board_snapshot\.bat_chg_level\s*==\s*0' 'active-low charger indication'
...
Assert-Contains $powerManager '\.charge_full\s*=\s*charge_power_present\s*&&\s*board_snapshot\.bat_std_level\s*==\s*0' 'charge-power-gated raw charge-full observation before debounce'
