...
Assert-Contains -RelativePath "ports/esp32/ble_hid_gap/ble_hid_gap_esp32.c" -Pattern "active connection parameters left to central" -Description "central-owned active connection parameter policy"
Assert-Contains -RelativePath "ports/esp32/ble_hid_gap/ble_hid_gap_esp32.c" -Pattern "low-power idle connection parameters left to central" -Description "central-owned low-power connection parameter policy"
...
Assert-NotContains -RelativePath "ports/esp32/ble_hid_gap/ble_hid_gap_esp32.c" -Pattern "ble_hid_gap_request_connection_params" -Description "device-initiated BLE connection parameter helper"
Assert-NotContains -RelativePath "ports/esp32/ble_hid_gap/ble_hid_gap_esp32.c" -Pattern "ble_gap_update_params" -Description "device-initiated BLE connection parameter update"
Assert-NotContains -RelativePath "ports/esp32/ble_hid_gap/ble_hid_gap_esp32.c" -Pattern "connection parameter update requested" -Description "device-initiated BLE connection parameter request log"
