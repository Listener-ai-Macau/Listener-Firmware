...
def main() -> int:
    ...
    if "active_work && percent < STATUS_LED_CHARGING_ACTIVE_WORK_MIN_PERCENT" not in status_led:
        failures.append("status_led.c: charging PWR breath must stay readable during recording/processing")
    for token in (
