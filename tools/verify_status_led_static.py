...
CHECKS = {
    ...
    "components/status_led/status_led.c": [
        ...
        "STATUS_LED_FULL_BREATH_PERIOD_MS 5200U",
        "STATUS_LED_FULL_BREATH_MIN_PERCENT 30U",
        "STATUS_LED_FULL_BREATH_MAX_PERCENT 46U",
        "STATUS_LED_FULL_STATUS_BREATH_MIN_PERCENT 38U",
        "STATUS_LED_FULL_STATUS_BREATH_MAX_PERCENT 58U",
        "STATUS_LED_CONTRACT_REV \"status_key_isolated_power_breath_v8\"",
    ...
    "docs/features/status_led.md": [
        ...
        "full is a slower, lower-contrast white breath",
    ...
    "tools/status_led_camera_calibration.ps1": [
        ...
        "status_key_isolated_power_breath_v8",
