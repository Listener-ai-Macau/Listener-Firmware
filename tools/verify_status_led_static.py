...
CHECKS = {
    ...
    "components/status_led/status_led.c": [
        ...
        "STATUS_LED_CHARGING_BREATH_PERIOD_MS 1400U",
        "STATUS_LED_CHARGING_BREATH_MIN_PERCENT 12U",
        ...
        "STATUS_LED_CONTRACT_REV \"status_key_isolated_charge_high_contrast_v11\"",
    ...
    "docs/features/status_led.md": [
        ...
        "continuous, high-contrast white breath with a deeper dim valley and a quicker cycle",
        ...
        "50% user brightness setting turns a 12-100% external-power breath into roughly 6-50%",
    ...
    "tools/status_led_camera_calibration.ps1": [
        ...
        "status_key_isolated_charge_high_contrast_v11",
