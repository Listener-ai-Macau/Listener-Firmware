...
CHECKS = {
    ...
    "components/status_led/status_led.c": [
        ...
        "STATUS_LED_CHARGING_BREATH_PERIOD_MS 2200U",
        ...
        "STATUS_LED_CONTRACT_REV \"status_key_isolated_charge_deeper_breath_v13\"",
        ...
        "status_led_eased_triangle_percent",
    ...
    "docs/features/status_led.md": [
        ...
        "continuous, high-contrast white breath with a much deeper dim valley, calmer cycle, and eased curve",
    ...
    "tools/status_led_camera_calibration.ps1": [
        ...
        "status_key_isolated_charge_deeper_breath_v13",
