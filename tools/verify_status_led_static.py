...
CHECKS = {
    ...
    "docs/features/status_led.md": [
        ...
        "continuous, high-contrast white breath with a much deeper 1% dim valley, a brief valley hold",
        "quick smooth inhale, and a longer smooth exhale",
