...
CHECKS = {
    ...
    "components/status_led/status_led.c": [
        ...
        "STATUS_LED_CHARGING_BREATH_HIGH_HOLD_MS 120U",
        ...
        "STATUS_LED_CONTRACT_REV \"status_key_isolated_charge_valley_hold_v14\"",
    ...
    "docs/features/status_led.md": [
        ...
        "continuous, high-contrast white breath with a much deeper 1% dim valley, a short valley hold",
        ...
        "50% user brightness setting turns a 1-100% external-power breath into roughly 1-50%",
        "charging breath includes a short 1% valley hold",
    ...
    "tools/status_led_camera_calibration.ps1": [
        ...
        "status_key_isolated_charge_valley_hold_v14",
