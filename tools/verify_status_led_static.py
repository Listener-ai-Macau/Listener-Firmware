...
CHECKS = {
    ...
    "components/status_led/status_led.c": [
        ...
        "STATUS_LED_CHARGING_BREATH_MIN_PERCENT 3U",
        ...
        "STATUS_LED_CONTRACT_REV \"status_key_isolated_charge_deep_breath_v12\"",
    ...
    "docs/features/status_led.md": [
        ...
        "continuous, high-contrast white breath with a deeper dim valley and calmer cycle",
        ...
        "50% user brightness setting turns a 3-100% external-power breath into roughly 2-50%",
    ...
    "tools/status_led_camera_calibration.ps1": [
        ...
        "status_key_isolated_charge_deep_breath_v12",
