...
Assert-Contains -RelativePath $stream -Pattern "(?s)s_replay_pending\s*&&\s*s_replay_session_id\s*==\s*session_id.*?ble_audio_stream_replay_store_packet" -Description "current audio packet retained before replay drain"
