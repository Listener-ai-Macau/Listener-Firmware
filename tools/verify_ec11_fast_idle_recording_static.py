...
CHECKS = {
    "ports/esp32/voice_key_input/voice_key_input_esp32.c": (
        ...
        "voice_key_input_generated_single_click_active(void)",
        "bool generated_single_click = voice_key_input_generated_single_click_active();",
        "!s_direct_generated_active || generated_single_click",
    ...
    "ports/esp32/ble_hid/ble_hid.c": (
        ...
        "ble_hid_usb_command_is_fast_idle_diagnostic_key(const char *line)",
        "ble_hid_usb_command_starts_with_boundary(line, \"KEY:EC11:SINGLE\")",
        "EC11 generated single preserves CONNECTED_IDLE before raw edge",
    ),
