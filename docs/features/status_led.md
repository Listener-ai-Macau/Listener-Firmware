...
User brightness scales the whole routine effect envelope before the profile cap is applied. A 50% user brightness setting turns a 12-100% external-power breath into roughly 6-50%, rather than clipping all samples above 50% into a flat line.
