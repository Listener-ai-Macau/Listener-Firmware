...
void board_print_help(void)
{
    static const char *help_string =
        ...
        "Hardware voice key uses KEY1/GPIO45: press once to start, press again to stop.\n"
        "Physical HID keys: KEY2/GPIO48=w, KEY3/GPIO47=a, KEY4/GPIO21=s.\n"
        "KEY2-KEY4 send BLE HID w/a/s when a host is connected.\n"
        ...
        "N4 deep sleep wakes by KEY4/GPIO21; KEY1/GPIO45 voice key is not RTC deep-sleep wake capable.\n"
