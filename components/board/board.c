...
void board_print_help(void)
{
    static const char *help_string =
        ...
        "EC11 push/GPIO18 is the physical power-on key; after boot, single click sends the EC11 custom-key fallback Shift+F13 after the 200 ms recovery decision window with an 80 ms minimum second-click gap.\n"
        ...
        "Device settings: ~DEVICE:SETTINGS reports user device config; ~DEVICE:SET plugged_brightness=80 battery_brightness=80 low_power_idle_minutes=1 plugged_low_power_enabled=0 auto_shutdown_minutes=off ble_name=listener updates persisted settings.\n"
