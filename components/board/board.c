...
void board_print_help(void)
{
    static const char *help_string =
        ...
        "VOICE uses GPIO45 on the current N4 board legacy KEY1 pin: press once to start, press again to stop.\n"
        "Logical custom keys: KEY1/GPIO48 fallback=F13, KEY2/GPIO47 fallback=F14, KEY3/GPIO21 fallback=F15.\n"
        "KEY1-KEY3 send safe non-text BLE HID fallback usages while Listener-Type custom actions are unavailable.\n"
        "Hold VOICE for 5s or send ~VREC:RECOVERY to clear pairing/session state.\n"
        ...
        "N4 deep sleep wakes by KEY3/GPIO21; VOICE/GPIO45 is not RTC deep-sleep wake capable.\n"
