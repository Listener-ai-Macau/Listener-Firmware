...
#define DIAG_GAP_RECOVERY      10  /* a1=action(1=clear_bonds,2=terminate_conn,3=restart_adv,4=complete,5=reserved_identity_rotation_removed,6=refresh_pairing_window,7=request_reconnect), a2=result, a3=bond_count_or_state_flags, a4=conn_handle */
