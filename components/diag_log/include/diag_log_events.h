...
#define DIAG_GAP_RECOVERY      10  /* a1=action(1=clear_bonds,2=terminate_conn,3=restart_adv,4=complete,5=rotate_identity,6=refresh_pairing_window,7=request_reconnect,8=keep_adv_connectable,9=bond_lookup_after_disconnect,10=request_security,11=reserved,12=windows_connecting,13=pre_reset_secure_ignored,14=pre_reset_disconnect,15=async_local_bond_delete,16=defer_adv_for_bond_delete,17=reject_conn_for_bond_delete,18=apply_ble_name), a2=result, a3=bond_count_or_state_flags, a4=conn_handle */
