...
/* Settings-revision characteristic UUID comes from the shared platform contract. */
#define BLE_AUDIO_STREAM_DEVICE_SETTINGS_REVISION_UUID \
    BLE_UUID128_INIT(DENZIC_DEVICE_CONTROL_V1_SETTINGS_REVISION_UUID_BYTES)
