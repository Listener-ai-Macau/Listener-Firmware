...
#ifndef CONFIG_LISTENER_BOARD_PROFILE_N4
#define CONFIG_LISTENER_BOARD_PROFILE_N4 1
#endif

#if !CONFIG_LISTENER_BOARD_PROFILE_N4
#error "This build baseline is configured for the Voice Keyboard N4 board profile."
#endif

#define BOARD_PINS_PROFILE_ID        "voice-keyboard-n4"
#define BOARD_PINS_MODULE            "ESP32-S3-WROOM-1-N4"
#define BOARD_PINS_FLASH_SIZE_MB     (4)
#define BOARD_PINS_PSRAM_SIZE_MB     (0)
#define BOARD_PINS_PSRAM_MODE        "none"
...
#define BOARD_PINS_RGB_STATUS_IO     (GPIO_NUM_NC)
#define BOARD_PINS_RGB_KEY_IO        (GPIO_NUM_NC)
#define BOARD_PINS_RGB_EDGE_IO       (GPIO_NUM_NC)

#define BOARD_PINS_PWR_HOLD_IO       (GPIO_NUM_NC)
